...
To speed up analysis, different orthogroups can be run simultaneously. To run BUSTED[S] in this manner, use the command `./scripts/BUSTEDmultithreaded [absolute path to the gene tree files from Orthofinder, something like /workdir/mb2337/FormicidaeMolecularEvolution/5_Orthofinder/fasta/Orthofinder/Results*/Resolved_Gene_Trees]`. I would recommend this approach.
